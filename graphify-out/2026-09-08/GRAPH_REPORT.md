...
## Corpus Check
- 322 files · ~75,758 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1196 nodes · 2536 edges · 121 communities (82 shown, 39 thin omitted)
...
6. `IntegrationWebhookEvent` - 40 edges
7. `Team` - 35 edges
...
Cohesion: 0.08
Nodes (14): DailyMeetingController, DailyMeetingEntryController, DevelopmentPlanController, DevelopmentPlanItemController, ExternalNotificationWebhookController, OneOnOneSessionController, OneOnOneTemplateController, PersonDeliveryMetricController (+6 more)

### Community 4 - "Team"
Cohesion: 0.11
Nodes (5): Team, Tenant, TeamPolicy, RegisterUserService, tenantFixture()
...
### Community 11 - "User"
Cohesion: 0.13
Nodes (6): User, OneOnOneSessionPolicy, LoginService, LogoutService, Illuminate\Foundation\Auth\User, Laravel\Sanctum\PersonalAccessToken

### Community 12 - "CrudControllerTrait.php"
Cohesion: 0.18
Nodes (14): PersonController, TeamController, destroy(), findModel(), index(), resolveDeleteService(), resolveIndexService(), resolveStoreService() (+6 more)

### Community 13 - "Illuminate\Database\Eloquent\Factories\HasFactory"
Cohesion: 0.11
Nodes (7): DevelopmentPlanFactory, IntegrationSystemFactory, OneOnOneTemplateFactory, TeamFactory, Illuminate\Database\Eloquent\Attributes\Fillable, Illuminate\Database\Eloquent\Factories\HasFactory, Illuminate\Database\Eloquent\SoftDeletes

### Community 14 - "Illuminate\Http\JsonResponse"
Cohesion: 0.12
Nodes (8): InvalidCredentialsException, AuthController, ClickUpWebhookController, GitHubWebhookController, IntegrationWebhookEventController, IntegrationWebhookEventResource, Exception, Illuminate\Http\JsonResponse
...
Cohesion: 0.05
Nodes (25): delete(), store(), update(), PersonExternalIdentity, PersonExternalIdentityPolicy, AcceptPersonInvitationService, DailyMeetingStoreService, GenericDeleteService (+17 more)
...
### Community 20 - "Illuminate\Database\Eloquent\Factories\Factory"
Cohesion: 0.13
Nodes (6): DailyMeetingFactory, DevelopmentPlanItemFactory, ExternalNotificationFactory, PersonExternalIdentityFactory, TenantFactory, Illuminate\Database\Eloquent\Factories\Factory

### Community 21 - "IntegrationSystem"
Cohesion: 0.07
Nodes (6): IntegrationSystem, IntegrationSystemPolicy, ClickUpWebhookIngestService, ExternalNotificationIngestService, GitHubWebhookIngestService, IntegrationWebhookEventFactory

### Community 22 - "User.php"
Cohesion: 0.28
Nodes (5): static, UserFactory, Illuminate\Database\Eloquent\Attributes\Hidden, Illuminate\Notifications\Notifiable, Laravel\Sanctum\HasApiTokens
...
### Community 24 - "Person"
Cohesion: 0.06
Nodes (8): PersonGrowthSuggestionController, Person, Attribute, PersonPolicy, PersonInvitationCreateService, Illuminate\Database\Eloquent\Casts\Attribute, Illuminate\Database\Eloquent\Relations\HasMany, Illuminate\Database\Eloquent\Relations\HasOne
...
Cohesion: 0.15
Nodes (3): IntegrationWebhookEvent, IntegrationWebhookEventPolicy, DeliveryMetricIngestService
...
Cohesion: 0.12
Nodes (3): PersonInvitation, PersonInvitationFactory, Illuminate\Database\Eloquent\Relations\BelongsTo
...
- **Why does `User` connect `User` to `DailyMeetingEntry`, `Team`, `PersonOneOnOneNote`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `IntegrationWebhookEventManagementTest.php`, `Illuminate\Database\Eloquent\Model`, `IntegrationSystem`, `User.php`, `Person`, `DevelopmentPlanItem`, `PersonDeliveryMetric`, `DevelopmentPlan`, `DailyMeeting`, `IntegrationWebhookEvent`, `Illuminate\Database\Eloquent\Relations\BelongsTo`, `ExternalNotification`, `OneOnOneTemplate`, `IntegrationWebhookTest.php`, `DailyMeetingAnnotation`, `DatabaseSeeder.php`?**
  _High betweenness centrality (0.125) - this node is a cross-community bridge._
- **Why does `Person` connect `Person` to `Illuminate\Database\Eloquent\Relations\BelongsTo`, `DailyMeetingEntry`, `Controller`, `OneOnOneSession`, `Team`, `IntegrationWebhookTest.php`, `PersonOneOnOneNote`, `CrudControllerTrait.php`, `Filterable.php`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `DailyMeetingAnnotation`, `Person.php`, `IntegrationWebhookEventManagementTest.php`, `Illuminate\Database\Eloquent\Model`, `Illuminate\Database\Eloquent\Factories\Factory`, `IntegrationSystem`, `DevelopmentPlan`, `DailyMeeting`?**
  _High betweenness centrality (0.088) - this node is a cross-community bridge._
- **Why does `IntegrationSystem` connect `IntegrationSystem` to `Controller`, `IntegrationSystemController.php`, `Team`, `IntegrationWebhookTest.php`, `Filterable.php`, `Illuminate\Database\Eloquent\Factories\HasFactory`, `IntegrationWebhookEventManagementTest.php`, `Illuminate\Database\Eloquent\Model`, `Illuminate\Database\Eloquent\Factories\Factory`, `Person`?**
